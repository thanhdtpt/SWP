                                  ...
                                  <div class="order-item order-item__action">
                                      ...
                                      <div class="order-item-body" style="padding-left: 36px;">
                                          <div class="order-item order-item__product">
                                              <div class="order-item order-item__product-image"
                                                   style="background-image: url(${requestScope.p.images1});">
                                              </div>
                                              <div class="order-item order-item__product-content">
                                                  <div>
                                                      <div class="order-item order-item__product-content order-item__product-content--name">
                                                          <span class="_30COVM">
                                                              ${requestScope.p.productname}
                                                              <input type="text" name="pid" value="${requestScope.p.id}" style="display: none"/>
                                                          </span>
                                                      </div>
                                                  </div>
                                                  <div class="order-item order-item__product-content order-item__product-content--attributes">
                                                      <div class="order-item__product-content--attributes order-item__product-content--type" style="height: 100%">
                                                          <div class="order-product-item order-product-type" style="margin-right: 139px;">Phân loại hàng: ${requestScope.p.categories.name}</div>
                                                              <div class="order-product-item order-product-price">
                                                                  <div class="order-product-item__oldprice" >${requestScope.p.oldPrice}đ</div>
                                                                  <div class="order-item__product-content--price">${requestScope.p.currentPrice}</div>
                                                              </div>
                                                      </div>
                                                              <div class="order-item__product-content--attributes order-item__product-content--unit">
                                                                  X${requestScope.quantity}
                                                                  <input clas="input-quantity" type="text" value="${requestScope.quantity}" name="quantity"style="display: none">
                                                              </div>
                                                  </div>
                                              </div>
                                          </div>
                                      ...
                                      <div class="_1l8TCL orderdetail-item-bill">
                                          <div class="_1FDuJg">
                                              ...
                                              <div class="_2aXD4G">
                                                  <div>${(requestScope.p.currentPrice)*(requestScope.quantity)}
                                                  </div>
                                                </div>
                                            </div>
                                            <div class="_1FDuJg">
