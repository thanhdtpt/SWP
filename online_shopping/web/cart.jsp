                           ...
                           <c:forEach items="${o.items}" var="i">
                                                    ...
                                                    <li class="shop__item--list--element">
                                                        ...
                                                        <div class="_1UHCH_ shop__item--voucher">
                                                            <svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0"
                                                                class="shopee-svg-icon _2MyMZE icon-free-shipping-line" style="font-size:10rem;">
                                                                <g>
                                                                    <line fill="none" stroke-linejoin="round" stroke-miterlimit="10"
                                                                        x1="8.6" x2="4.2" y1="9.8" y2="9.8">
                                                                    ...
                                                                    <line fill="none" stroke-miterlimit="10" x1="10.5" x2="14.4" y1="7.3"
                                                                        y2="7.3">
                                                            ...
                                                            <div class="UNDzvL">
                                                                Giảm ₫25.000 phí vận chuyển đơn tối thiểu ₫50.000; Giảm ₫70.000 phí vận
                                                                chuyển đơn tối thiểu ₫300.000</div>
                                ...
                                <div class="_2qn3bA _1F9REl">
                                    <div class="CsNHbu -Gs_Ma">
                                        ...
                                        <button class="_3eoyj7 clear-btn-style">Chọn tất cả (1)</button>
                                    <form action="process" method="post" >
                                             <button class="clear-btn-style ralv0t" type="submit">Xóa</button>
                                             <input type="hidden" name="id" value="${i.product.id}"/>
                                    </form>   

                                        <div class=""></div>
                                        <button class="clear-btn-style _2eG1ib">Lưu vào mục Đã thích</button>
                                        <div class="_2n5_2u"></div>
                                        <div class="_3p5aR1"><div class="_2nE2iF">
                                            <div class="_2LXtFJ"><div class="_333O5j">:</div>
                                            <div id="tien" class="ZxTZV3"></div><span style="color: #ee4d2d;">₫</span></div>
                                        </div><div class="_1IjfdD"></div>
                                    </div>
